...
try:
    data = pandas.read_csv("EnglishVocabulary/data/words_to_learn.csv", encoding="utf-8", delimiter=":;", engine='python')
except FileNotFoundError:
    original_data = pandas.read_csv("EnglishVocabulary/data/new_data.csv", encoding="UTF-8", delimiter=":;", engine='python')
...
def is_known():
    ...
    data.to_csv("EnglishVocabulary/data/words_to_learn.csv", index=False)
    next_card()


canvas = Canvas(width=800, height=526)
canvas.config(highlightthickness=0, bg=BACKGROUND_COLOR)
card_front_img = PhotoImage(file="EnglishVocabulary/images/card_front.png")
card_back_img = PhotoImage(file="EnglishVocabulary/images/card_back.png")
...
wrong_img = PhotoImage(file="EnglishVocabulary/images/wrong.png")
wrong_button = Button(image=wrong_img, highlightthickness=0, command=next_card)
wrong_button.grid(row=1, column=0)

right_img = PhotoImage(file="EnglishVocabulary/images/right.png")
